...
public class PatternMatcher
{
    public static void Main(string[] args)
    {
        ...
        //     Image input = Image.FromFile("database/fingerprint (1).BMP");
        //     string ascii = parser.ConvertImageToAscii(input, Width, Height);

        //     // Belum ada MySQL jadi hardcode dulu
        //     Image img2 = Image.FromFile("database/fingerprint (2).BMP");
        //     string ascii2 = parser.ConvertImageToAscii(img2, Width, Height);

        //     Image img3 = Image.FromFile("database/fingerprint (3).BMP");
